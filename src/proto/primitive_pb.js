...
goog.exportSymbol('proto.iroha.protocol.DataModelId', null, global);
 ...
 * @constructor
 */
proto.iroha.protocol.DataModelId = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.iroha.protocol.DataModelId, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.iroha.protocol.DataModelId.displayName = 'proto.iroha.protocol.DataModelId';
}
 ...
 * @return {!Object}
 */
proto.iroha.protocol.DataModelId.prototype.toObject = function(opt_includeInstance) {
  return proto.iroha.protocol.DataModelId.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.iroha.protocol.DataModelId} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iroha.protocol.DataModelId.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.iroha.protocol.DataModelId.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.iroha.protocol.DataModelId;
  return proto.iroha.protocol.DataModelId.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.iroha.protocol.DataModelId} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.iroha.protocol.DataModelId}
 */
proto.iroha.protocol.DataModelId.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.iroha.protocol.DataModelId.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.iroha.protocol.DataModelId.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.iroha.protocol.DataModelId} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iroha.protocol.DataModelId.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.iroha.protocol.DataModelId.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.iroha.protocol.DataModelId.prototype.setName = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.iroha.protocol.DataModelId.prototype.getVersion = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.iroha.protocol.DataModelId.prototype.setVersion = function(value) {
  jspb.Message.setField(this, 2, value);
};
