...
proto.iroha.protocol.CompareAndSetAccountDetail.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    checkEmpty: jspb.Message.getFieldWithDefault(msg, 5, false)
  };
...
proto.iroha.protocol.CallEngine.prototype.setCallee = function(value) {
  jspb.Message.setOneofField(this, 3, proto.iroha.protocol.CallEngine.oneofGroups_[0], value);
};


proto.iroha.protocol.CallEngine.prototype.clearCallee = function() {
  jspb.Message.setOneofField(this, 3, proto.iroha.protocol.CallEngine.oneofGroups_[0], undefined);
};
