...
export function publickey_from_raw(a: number, b: number, c: number): void;
...
export function publickey_to_json(a: number, b: number): void;
...
export function privatekey_from_raw(a: number, b: number, c: number): void;
...
export function keypair_from_raw(a: number, b: number, c: number): void;
export function keypair_generate_from_seed(a: number, b: number, c: number): void;
export function keypair_generate_from_private_key(a: number, b: number): void;
...
export function signature_from_json(a: number, b: number): void;
export function signature_from_raw(a: number, b: number, c: number): void;
...
export function signature_to_json(a: number, b: number): void;
