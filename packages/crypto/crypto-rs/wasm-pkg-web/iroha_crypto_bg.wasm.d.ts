...
export function signature_create_from_key_pair(a: number, b: number, c: number): void;
export function signature_create_from_public_key(a: number, b: number, c: number): void;
export function signature_verify_wasm(a: number, b: number, c: number): void;
...
export function hash_clone_bytes(a: number, b: number): void;
export function hash_hash(a: number, b: number): number;
export function hash_zeroed(): number;
export function __wbg_keygenconfiguration_free(a: number): void;
export function keygenconfiguration_default_wasm(): number;
...
export function keypair_digest_function_wasm(a: number): number;
export function keypair_private_key_wasm(a: number): number;
export function keypair_public_key_wasm(a: number): number;
export function keypair_from_json(a: number, b: number): void;
export function keypair_generate_with_configuration_wasm(a: number, b: number): void;
export function keypair_generate_wasm(a: number): void;
...
export function publickey_from_bytes(a: number, b: number): void;
