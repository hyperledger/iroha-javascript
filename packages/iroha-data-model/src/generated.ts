...
] = [iroha_data_model_account_Id_encode, iroha_data_model_account_Account_encode].map(makeEncoderAsIsRespectable) as [
...
] = [iroha_data_model_asset_DefinitionId_encode, iroha_data_model_asset_AssetDefinitionEntry_encode].map(
  makeEncoderAsIsRespectable
) as [
...
] = [iroha_data_model_asset_Id_encode, iroha_data_model_asset_Asset_encode].map(makeEncoderAsIsRespectable) as [
...
] = [str_encode, iroha_data_model_expression_EvaluatesTo_iroha_data_model_Value_encode].map(
  makeEncoderAsIsRespectable
) as [
...
const iroha_crypto_Hash_encoders = [Array_u8_32_encode].map(makeEncoderAsIsRespectable)
...
const iroha_data_model_account_SignatureCheckCondition_encoders = [
  iroha_data_model_expression_EvaluatesTo_bool_encode,
...
const iroha_data_model_asset_AssetValue_decoders: EnumDecoders = {
  ...
  2: { v: 'Store', decode: iroha_data_model_metadata_Metadata_decode },
}
const iroha_data_model_asset_AssetValue_encoders: EnumEncoders = {
  ...
  Store: { d: 2, encode: iroha_data_model_metadata_Metadata_encode },
}
...
const iroha_data_model_events_SubscriptionRequest_encoders = [iroha_data_model_events_EventFilter_encode].map(
  makeEncoderAsIsRespectable
)
...
const iroha_data_model_events_VersionedEventSocketMessageV1_encoders = [
  iroha_data_model_events_EventSocketMessage_encode,
].map(makeEncoderAsIsRespectable)
...
export function iroha_data_model_expression_Contains_decode(
  ...
  return decodeStruct(bytes, iroha_data_model_expression_Contains_decoders, iroha_data_model_expression_Contains_order)
}
...
const iroha_data_model_expression_Divide_order: (keyof iroha_data_model_expression_Divide_Decoded)[] = ['left', 'right']
...
export function iroha_data_model_expression_Divide_encode(
  ...
  return encodeStruct(encodable, iroha_data_model_expression_Divide_encoders, iroha_data_model_expression_Divide_order)
}
...
export function iroha_data_model_expression_Multiply_decode(
  ...
  return decodeStruct(bytes, iroha_data_model_expression_Multiply_decoders, iroha_data_model_expression_Multiply_order)
}
...
export function iroha_data_model_expression_Subtract_decode(
  ...
  return decodeStruct(bytes, iroha_data_model_expression_Subtract_decoders, iroha_data_model_expression_Subtract_order)
}
...
export function iroha_data_model_isi_UnregisterBox_encode(
  ...
  return encodeStruct(encodable, iroha_data_model_isi_UnregisterBox_encoders, iroha_data_model_isi_UnregisterBox_order)
}
...
export function iroha_data_model_metadata_Metadata_encode(
  ...
  return encodeStruct(encodable, iroha_data_model_metadata_Metadata_encoders, iroha_data_model_metadata_Metadata_order)
}
...
export type iroha_data_model_query_QueryBox_Encodable = Enum<{
  ...
  FindAssetKeyValueByIdAndKey: Valuable<iroha_data_model_query_asset_FindAssetKeyValueByIdAndKey_Encodable | EncodeAsIs>
...
const iroha_data_model_query_QueryBox_decoders: EnumDecoders = {
  ...
  10: { v: 'FindAssetsByAssetDefinitionId', decode: iroha_data_model_query_asset_FindAssetsByAssetDefinitionId_decode },
  ...
  15: { v: 'FindAllDomains', decode: iroha_data_model_query_domain_FindAllDomains_decode },
  16: { v: 'FindDomainByName', decode: iroha_data_model_query_domain_FindDomainByName_decode },
  17: { v: 'FindAllPeers', decode: iroha_data_model_query_peer_FindAllPeers_decode },
  18: {
...
const iroha_data_model_query_QueryBox_encoders: EnumEncoders = {
  ...
  FindAccountKeyValueByIdAndKey: { d: 2, encode: iroha_data_model_query_account_FindAccountKeyValueByIdAndKey_encode },
  ...
  FindAllDomains: { d: 15, encode: iroha_data_model_query_domain_FindAllDomains_encode },
  FindDomainByName: { d: 16, encode: iroha_data_model_query_domain_FindDomainByName_encode },
  FindAllPeers: { d: 17, encode: iroha_data_model_query_peer_FindAllPeers_encode },
  FindTransactionsByAccountId: { d: 18, encode: iroha_data_model_query_transaction_FindTransactionsByAccountId_encode },
...
const iroha_data_model_query_QueryResult_encoders = [iroha_data_model_Value_encode].map(makeEncoderAsIsRespectable)
...
const iroha_data_model_query_VersionedQueryResultV1_encoders = [iroha_data_model_query_QueryResult_encode].map(
  makeEncoderAsIsRespectable
)
...
const iroha_data_model_query_VersionedSignedQueryRequestV1_decoders = [iroha_data_model_query_SignedQueryRequest_decode]
const iroha_data_model_query_VersionedSignedQueryRequestV1_encoders = [
  iroha_data_model_query_SignedQueryRequest_encode,
].map(makeEncoderAsIsRespectable)
...
export function iroha_data_model_transaction_Payload_decode(
  ...
  return decodeStruct(bytes, iroha_data_model_transaction_Payload_decoders, iroha_data_model_transaction_Payload_order)
}
...
export type iroha_data_model_transaction_RejectedTransaction_Decoded = {
  ...
  signatures: Vec_iroha_crypto_Signature_Decoded
...
export type iroha_data_model_transaction_RejectedTransaction_Encodable = {
  ...
  signatures: Vec_iroha_crypto_Signature_Encodable | EncodeAsIs
...
const iroha_data_model_transaction_RejectedTransaction_decoders = {
  ...
  signatures: Vec_iroha_crypto_Signature_decode,
...
const iroha_data_model_transaction_RejectedTransaction_encoders = {
  ...
  signatures: makeEncoderAsIsRespectable(Vec_iroha_crypto_Signature_encode),
...
const iroha_data_model_transaction_VersionedRejectedTransactionV1_encoders = [
  iroha_data_model_transaction_RejectedTransaction_encode,
].map(makeEncoderAsIsRespectable)
...
const iroha_data_model_transaction_VersionedTransactionV1_encoders = [
  iroha_data_model_transaction_Transaction_encode,
].map(makeEncoderAsIsRespectable)
...
const iroha_data_model_Value_decoders: EnumDecoders = {
  ...
  3: { v: 'Vec', decode: Vec_iroha_data_model_Value_decode },
  4: { v: 'Id', decode: iroha_data_model_IdBox_decode },
  5: { v: 'Identifiable', decode: iroha_data_model_IdentifiableBox_decode },
  6: { v: 'PublicKey', decode: iroha_crypto_PublicKey_decode },
  7: { v: 'Parameter', decode: iroha_data_model_Parameter_decode },
  8: { v: 'SignatureCheckCondition', decode: iroha_data_model_account_SignatureCheckCondition_decode },
  9: { v: 'TransactionValue', decode: iroha_data_model_transaction_TransactionValue_decode },
  10: { v: 'PermissionToken', decode: iroha_data_model_permissions_PermissionToken_decode },
}
const iroha_data_model_Value_encoders: EnumEncoders = {
  ...
  Vec: { d: 3, encode: Vec_iroha_data_model_Value_encode },
  Id: { d: 4, encode: iroha_data_model_IdBox_encode },
  Identifiable: { d: 5, encode: iroha_data_model_IdentifiableBox_encode },
  PublicKey: { d: 6, encode: iroha_crypto_PublicKey_encode },
  Parameter: { d: 7, encode: iroha_data_model_Parameter_encode },
  SignatureCheckCondition: { d: 8, encode: iroha_data_model_account_SignatureCheckCondition_encode },
  TransactionValue: { d: 9, encode: iroha_data_model_transaction_TransactionValue_encode },
  PermissionToken: { d: 10, encode: iroha_data_model_permissions_PermissionToken_encode },
}
...
export function Vec_iroha_crypto_PublicKey_encode(encodable: Vec_iroha_crypto_PublicKey_Encodable): Uint8Array {
  return encodeVec(encodable, iroha_crypto_PublicKey_encode)
}
...
export function Vec_iroha_crypto_Signature_encode(encodable: Vec_iroha_crypto_Signature_Encodable): Uint8Array {
  return encodeVec(encodable, iroha_crypto_Signature_encode)
}
...
export type Vec_iroha_data_model_isi_Instruction_Encodable = (iroha_data_model_isi_Instruction_Encodable | EncodeAsIs)[]
...
export function Vec_iroha_data_model_isi_Instruction_encode(
  ...
  return encodeVec(encodable, iroha_data_model_isi_Instruction_encode)
}
...
export function Vec_iroha_data_model_permissions_PermissionToken_encode(
  ...
  return encodeVec(encodable, iroha_data_model_permissions_PermissionToken_encode)
}
...
export function Vec_iroha_data_model_Value_encode(encodable: Vec_iroha_data_model_Value_Encodable): Uint8Array {
  return encodeVec(encodable, iroha_data_model_Value_encode)
}
